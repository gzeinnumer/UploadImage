...
import com.gzeinnumer.uploadimage.server.RetroServer;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<ImagesItem> list = new ArrayList<>();
    ...
    private void reqData() {
        RetroServer.getInstance().getAllData().enqueue(new Callback<ResponseGambar>() {
            @Override
    ...
    private void initData() {
        AdapterRV adapter = new AdapterRV(getApplicationContext(), list);
